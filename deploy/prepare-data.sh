...
function prepare() {
    ...
    docker run -t -v "/data/osm/osrm:/data" osrm/osrm-backend osrm-extract -p /opt/car.lua "/data/${country}.osm.pbf"
    docker run -t -v "/data/osm/osrm:/data" osrm/osrm-backend osrm-partition "/data/${country}.osrm"
    docker run -t -v "/data/osm/osrm:/data" osrm/osrm-backend osrm-customize "/data/${country}.osrm"
}
