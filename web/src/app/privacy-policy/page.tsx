  ...
  return (
    <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      <div className="bg-gray-700 lg:mx-96 p-4 rounded-md">
        ...
        <p>This policy is effective as of 2021-02-16</p>{" "}
        <p>
          <strong>Contact Us</strong>
        </p>{" "}
        <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at augustin.gjini@pm.me.</p>
      </div>
    </div>
  );
}
