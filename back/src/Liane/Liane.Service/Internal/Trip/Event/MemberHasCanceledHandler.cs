...
public sealed class MemberHasCanceledHandler(
  ITripService tripService,
  IUserService userService,
  INotificationService notificationService,
  ICurrentContext currentContext)
  : IEventListener<TripEvent.MemberHasCanceled>
{
  public async Task OnEvent(TripEvent.MemberHasCanceled e, Ref<Api.Auth.User>? sender = null)
  {
