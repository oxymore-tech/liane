...
namespace Liane.Api.Osrm
{
    ...
    {
        public Intersection(LatLng location, ImmutableList<int> bearings, ImmutableList<string> classes, ImmutableList<string> entry, int @in, int @out, ImmutableList<Lane> lanes)
        {
            Location = location;
            Bearings = bearings;
            Classes = classes;
