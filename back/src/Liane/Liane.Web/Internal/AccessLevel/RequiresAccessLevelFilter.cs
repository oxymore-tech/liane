...
public class RequiresAccessLevelFilter: IAsyncAuthorizationFilter
{
  ...
  public RequiresAccessLevelFilter(IServiceProvider serviceProvider, ICurrentContext currentContext, IAccessLevelContextFactory provider,  ResourceAccessLevel accessLevel, Type resourceType, string resourceIdentifier)
  {
