...
public sealed class PaginationTest
{
  ...
  public void ShouldPaginateWithoutCursorInMemory()
  {
    ...
    var actual = list.Paginate(new Pagination(), e => e.Id);
  ...
  public void ShouldPaginateWithCursorInMemory()
  {
    ...
    var actual = list.Paginate(new Pagination(new Cursor.Time(new DateTime(2023, 02, 16), null), 3), e => e.CreatedAt);
  ...
  public void ShouldPaginateWithCursorInMemoryWithNext()
  {
    ...
    var actual = list.Paginate(new Pagination(new Cursor.Time(new DateTime(2023, 02, 15), null), 3), e => e.CreatedAt);
