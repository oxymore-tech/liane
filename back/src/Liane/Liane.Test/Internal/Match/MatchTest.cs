...
#pragma warning disable CS8625
    var liane1 = new Api.Trip.Trip(null, null, null, null, new DateTime(2023, 04, 7, 15, 31, 0), null, new List<WayPoint>
    {
...
#pragma warning restore CS8625
    ...
    {
      new(LabeledPositions.GorgesDuTarnCausses, 0, 0, DateTime.Now),
      new(LabeledPositions.ChamperbouxEglise, 0, 0, DateTime.Now),
      new(LabeledPositions.BalsiegeParkingEglise, 0, 0, DateTime.Now),
      new(LabeledPositions.Mende, 0, 0, DateTime.Now)
    }.ToImmutableList()));
    ...
    CollectionAssert.AreEqual(new List<RallyingPoint> { LabeledPositions.ChamperbouxEglise, LabeledPositions.BalsiegeParkingEglise, LabeledPositions.Mende },
      matchingTrip1.Select(w => w.RallyingPoint));
