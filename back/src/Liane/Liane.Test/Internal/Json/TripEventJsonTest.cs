...
[TestFixture]
public sealed class TripEventJsonTest
{
  ...
  public void ShouldSerialize()
  {
    var e = new Notification.Event("id", "augustin", DateTime.Parse("2023-03-03T00:00:00Z").ToUniversalTime(), ImmutableList<Recipient>.Empty, ImmutableHashSet.Create(Answer.Accept, Answer.Reject),
      ...
      new TripEvent.MemberHasLeft("6408a644437b60cfd3b15874", "augustin"));
  ...
  public void ShouldSerializeWithUri()
  {
    var e = new Notification.Event("id", "augustin", DateTime.Parse("2023-03-03T00:00:00Z").ToUniversalTime(), ImmutableList<Recipient>.Empty, ImmutableHashSet.Create(Answer.Accept, Answer.Reject),
      "Titre", "Augustin a quitté la liane",
      new TripEvent.JoinRequest("6408a644437b60cfd3b15874", "Ispa", "Blajoux", -1, false, "Coucou"));
    var actual = JsonSerializer.Serialize(e, options);
    Assert.AreEqual(
  ...
  {
    var actual = JsonSerializer.Serialize(new TripEvent.MemberPing("XXXX", ((DateTimeOffset)DateTime.Parse("2023-03-03T00:00:00Z")).ToUnixTimeMilliseconds(), TimeSpan.FromMinutes(15), null),
      options);
    Assert.AreEqual(
  ...
  {
    var joinRequest = new TripEvent.JoinRequest("6408a644437b60cfd3b15874", "Aurillac", "Medon", 2, false, "Hey !");
    var actual = JsonSerializer.Deserialize<TripEvent>(AssertExtensions.ReadTestResource("join-request.json"), options);
