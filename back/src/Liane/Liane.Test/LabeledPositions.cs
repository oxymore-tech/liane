...
public sealed class LabeledPositions
{
  ...
  public static readonly RallyingPoint GorgesDuTarnCausses =
    new("GorgesDuTarnCausses_fakeId", "GorgesDuTarnCausses", Positions.GorgesDuTarnCausses, LocationType.CarpoolArea, "", "48000", "", null, true);
  ...
  public static readonly RallyingPoint SaintEnimieParking = new("SaintEnimie_Parking_fakeId", "SaintEnimie_Parking", Positions.SaintEnimieParking, LocationType.CarpoolArea, "", "48000", "", null,
    true);
  ...
  public static readonly RallyingPoint SaintChelyDuTarnEnHaut =
    new("SaintChelyDuTarn_En_Haut_fakeId", "SaintChelyDuTarn_En_Haut", Positions.SaintChelyDuTarnEnHaut, LocationType.CarpoolArea, "", "48000", "", null, true);
  ...
  public static readonly RallyingPoint MontbrunParkingVillage =
    new("Montbrun_Parking_Village_fakeId", "Montbrun_Parking_Village", Positions.MontbrunParkingVillage, LocationType.CarpoolArea, "", "48000", "", null, true);
  ...
  public static readonly RallyingPoint SaintBauzileEglise = new("SaintBauzile_Eglise_fakeId", "SaintBauzile_Eglise", Positions.SaintBauzileEglise, LocationType.CarpoolArea, "", "48000", "", null,
    true);
  ...
  public static readonly RallyingPoint RouffiacBoulangerie =
    new("Rouffiac_Boulangerie_fakeId", "Rouffiac_Boulangerie", Positions.RouffiacBoulangerie, LocationType.CarpoolArea, "", "48000", "", null, true);

  public static readonly RallyingPoint BalsiegeParkingEglise =
    new("Balsiege_Parking_Eglise_fakeId", "Balsiege_Parking_Eglise", Positions.BalsiegeParkingEglise, LocationType.CarpoolArea, "", "48000", "", null, true);
  ...
  public static readonly RallyingPoint LanuejolsParkingEglise =
    new("Lanuejols_Parking_Eglise_fakeId", "Lanuejols_Parking_Eglise", Positions.LanuejolsParkingEglise, LocationType.CarpoolArea, "", "48000", "", null, true);
  ...
  public static readonly RallyingPoint VillefortParkingGare =
    new("Villefort_Parking_Gare_fakeId", "Villefort_Parking_Gare", Positions.VillefortParkingGare, LocationType.CarpoolArea, "", "48000", "", null, true);
